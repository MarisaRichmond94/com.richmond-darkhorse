...
public class BehaviorReportPane extends GridPane{
	...
	public BehaviorReportPane(Director director,Student student) {
	    ...
	    for(BehaviorReport behaviorReport : behaviorReports.values()) {
	    		String studentName = behaviorReport.getStudent(student.getStudentID()).getFirstName() + " " + behaviorReport.getStudent(student.getStudentID()).getLastName();
	    		String date = behaviorReport.getDate().toString();
