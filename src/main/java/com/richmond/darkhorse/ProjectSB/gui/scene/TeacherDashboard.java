...
public class TeacherDashboard extends Scene{
	...
	public TeacherDashboard(Stage stage,BorderPane layout,Scene nextScene,Teacher teacher) {
		...
		teacherDashboardLayout.setTop(topBar);
		teacherDashboardLayout.setBottom(bottomBar);
		teacherDashboardLayout.setLeft(leftSideBar);
		teacherDashboardLayout.setCenter(centerPane);
		teacherDashboardLayout.getStylesheets().add("teacherhome.css");
