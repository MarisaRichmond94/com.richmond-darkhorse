...
public class TeacherReportWorkspace extends Scene{
	...
	public TeacherReportWorkspace(Stage stage,BorderPane layout,Scene nextScene,Teacher teacher) {
		...
		teacherReportWorkspaceLayout.setTop(topBar);
		teacherReportWorkspaceLayout.setBottom(bottomBar);
		teacherReportWorkspaceLayout.setLeft(leftSideBar);
		teacherReportWorkspaceLayout.setCenter(centerPane);
		teacherReportWorkspaceLayout.getStylesheets().add("teacherhome.css");
