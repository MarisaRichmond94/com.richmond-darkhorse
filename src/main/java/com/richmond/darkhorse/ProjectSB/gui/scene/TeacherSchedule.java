...
public class TeacherSchedule extends Scene{
	...
	public TeacherSchedule(Stage stage,BorderPane layout,Scene nextScene,Teacher teacher) {
		...
		teacherScheduleLayout.setTop(topBar);
		teacherScheduleLayout.setBottom(bottomBar);
		teacherScheduleLayout.setLeft(leftSideBar);
		teacherScheduleLayout.setCenter(centerPane);
		teacherScheduleLayout.getStylesheets().add("teacherhome.css");
